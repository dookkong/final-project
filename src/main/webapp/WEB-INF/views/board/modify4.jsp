...
<div class="container" style="height: 1000px; margin-top: 100px;">
			<div>
                    	<form role="form" action="/board/modify4" method="post">
                          ...
                          <button type="submit" data-oper="modify4" class="btn btn-default">수정</button>
                          <button type="submit" data-oper="community4" class="btn btn-info">목록</button>
                    	</form>
             </div>
</div>                  
\
...
$(document).ready(function () {
	var formObj = $("form");
 	...
 	$("button").on("click", function (e) {
		...
		if(operation === "community4"){
			formObj.attr("action", "/board/community4")
				   .attr("method", "get");
		}
		formObj.submit();
	});
