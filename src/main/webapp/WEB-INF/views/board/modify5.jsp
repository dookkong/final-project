...
<div class="container" style="height: 1000px; margin-top: 100px;">
			<div>
                    	<form role="form" action="/board/modify5" method="post">
                          ...
                          <button type="submit" data-oper="modify5" class="btn btn-default">수정</button>
                          <button type="submit" data-oper="community5" class="btn btn-info">목록</button>
...
$(document).ready(function () {
	var formObj = $("form");
 	...
 	$("button").on("click", function (e) {
		...
		if(operation === "community5"){
			formObj.attr("action", "/board/community5")
				   .attr("method", "get");
		}
		formObj.submit();
	});
