	...
	<div  style="text-align: center; position: relative; right: 230px;" id="list">
        ...
        <br>
            <div class="panel-body">  	
                    ...
                    <tbody>
                      <c:forEach items="${InterviewAns}" var="board">
                          <tr class="odd gradeX">
                            ...
                            <td><a class="move" style="text-decoration: none; color: black;" href='/board/reg-detail2?bno=<c:out value="${board.bno }"/>'>
               ...
               <div class='row'>
                  <div class="col-lg-12">
                  <form id='searchForm' action="/board/community2" method="get">
                    <select name='type'>
              ...
              <ul class="pagination"
               ...
               width: 120px; color: black;">
                 	...
                 	<c:forEach var="num" begin="${pageMaker.startPage }" end="${pageMaker.endPage }">
                 		<li class="paginate_button ${pageMaker.cri.pageNum == num ? 'active':''}"><a href="community2?pageNum=${num }">${num }</a></li>
                 	</c:forEach>
            ...
            <form id="actionForm" action="/board/community2" method='get'>
