  ...
  <br>
    <div class="div">
	 ...
	 <sec:authorize access="isAuthenticated()">
        ...
        <form id="operForm" action="/board/modify4" method="get">
...
$(document).ready(function () {
	...
	$("button").on("click", function (e) {
		...
		if(operation === "modify"){
			operForm.attr("action", "/board/modify4");
		}else if(operation === "remove"){
			operForm.attr("action", "/board/remove4").attr("method","post");
	...
	$("#next").on("click", function (e) {
		e.preventDefault();
		location.href="/board/reg-detail4?bno='${board.bno+1}'.jsp";
	});
});
</script>